...
public class Open2Action extends MapMorpherAction
{
	...
	final static Logger logger = LoggerFactory.getLogger(Open2Action.class);
	...
	{
		VolatileConfiguration config = mapMorpher.getVolatileConfiguration();
