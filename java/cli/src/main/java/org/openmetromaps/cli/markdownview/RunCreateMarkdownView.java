...
package org.openmetromaps.cli.markdownview;
...
public class RunCreateMarkdownView
{
			...
			throws Exception
	{
		...
		MarkdownViewCreator creator = new MarkdownViewCreator(model);
		creator.create(pathOutput);
	}
