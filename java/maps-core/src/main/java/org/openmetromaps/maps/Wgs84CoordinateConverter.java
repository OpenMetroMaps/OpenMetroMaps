...
public class Wgs84CoordinateConverter implements CoordinateConverter
{

	final static Logger logger = LoggerFactory
			.getLogger(Wgs84CoordinateConverter.class);
	...
	public Wgs84CoordinateConverter(BBox bbox, double size, double margin)
	{
		this.margin = margin;
