...
convert "material-symbols" "add-circle-outline.svg"
convert "material-symbols" "arrow-circle-down-outline.svg"
convert "material-symbols" "arrow-circle-up-outline.svg"
convert "material-symbols" "delete-outline.svg"
