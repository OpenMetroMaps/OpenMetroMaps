...
public class ViewerOptionsPane extends JPanel
{

	private static final long serialVersionUID = 1L;

	public ViewerOptionsPane(Configuration configuration)
	{
		super(new BorderLayout());
		BorderHelper.addEmptyBorder(this, 10, 10, 10, 10);
		add(new JLabel("No viewer-specific options yet."), BorderLayout.NORTH);
	}

	public void setValues(Configuration configuration)
	{
		// no viewer-specific options yet
	}
